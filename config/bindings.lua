...
local keys = {
   ...
   { key = 'i', mods = mod.SUPER_REV, action = act.ActivatePaneDirection('Down') },
   { key = 'o', mods = mod.SUPER_REV, action = act.ActivatePaneDirection('Left') },
   { key = 'p', mods = mod.SUPER_REV, action = act.ActivatePaneDirection('Right') },
